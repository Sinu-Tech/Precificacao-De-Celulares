...
Original file is located at
    https://colab.research.google.com/drive/18YCbTitrO7jhyyNMHouNkMIvQoy7HR3u
"""
...
"""Teste para IphoneX (Falta corrigir)"""

iphoneX = [{'baterry_power': 2716, 'blue':1, 'clock_speed': 2.4, 'dual': 0, 'fc': 12,'fourg': 1, 'int_memory':256, 'm_dep': 0.8, 'mobile_wt': 174, 'n_cores': 3, 'pc': 12, 'px_height': 2436, 'px_width': 1125, 'ram': 3064, 'sc_h': 14, 'sc_w': 7, 'talk_time': 21, 'three_g': 1, 'touch_screnn': 1, 'wifi': 1}]
iphoneX = pd.DataFrame(iphoneX)

pred = modelo.predict(iphoneX)

print(f'esperado: {iphoneX}, resultado: {pred}')

"""Mostra a porcentagem de acertos"""

accuracy_score(pred, iphoneX)*100